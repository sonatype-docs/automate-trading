...
function DashboardPage() {
  ...
  const metrics = {
    equity: Number(payload.metrics?.equity ?? 0),
    todaysPnl: Number(payload.metrics?.todaysPnl ?? 0),
    openPositions: Number(payload.metrics?.openPositions ?? positions.length),
    winRate: Number(payload.metrics?.winRate ?? 0),
  };
